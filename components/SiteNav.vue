...
import { Bars3Icon, XMarkIcon } from "@heroicons/vue/24/solid/index";
...
<template>
  ...
  <div class="site-nav-action-cont">
    <button
      @click="toogleNav"
      class="py-2 shadow-lg site-nav-btn cta bg-space-cadet-50 dark:bg-space-cadet-900"
    >
      <XMarkIcon v-if="navActive" class="w-6 h-6 icon" />
      <Bars3Icon v-else class="w-6 h-6 icon" />
    </button>
  </div>
</template>
<style scoped>
